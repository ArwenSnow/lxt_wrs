...
if __name__ == '__main__':
    ...
    app3_jnts = np.array([-0.21031217, 0.41259584, 0.40788345, -1.65352493, -0.07522369, -0.15358897])
    ...
    gri3_jnts = np.array([-0.17139133, 0.70982541, 0.22881266, -2.14047179, -0.04642576, 0.3577925])
