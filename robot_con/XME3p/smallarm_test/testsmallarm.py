...
finger_r.disable_dxl_torque(1)
finger_r.disable_dxl_torque(2)
finger_r.disable_dxl_torque(3)
...
def update_task(task):
    ...
    try:
        a = finger_r.get_dxl_pos(1)
        b = finger_r.get_dxl_pos(2)
        c = finger_r.get_dxl_pos(3)
        a = (a - 2048) / 4096 * 2 * math.pi
        b = (b - 2048) / 4096 * 2 * math.pi
        c = (c - 2048) / 4096 * 2 * math.pi
        data_to_send = f"[{a:.2f}, {b:.2f}, {c:.2f}]"
