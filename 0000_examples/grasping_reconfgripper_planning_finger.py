...
if finger_type == 'a':
    ...
    finger = "objects/finger_b_1.0.stl"
elif finger_type == 'c':
    finger = "objects/finger_c_old.stl"
elif finger_type == 'd':
    finger = 'objects/finger_c_2.0.stl'
else:
...
object_1 = cm.CollisionModel("objects/screw.stl")
object_1.set_rgba([.7, .7, .7, 1])
object_1.set_pos(np.array([.0, .0, .0]))

object_2 = cm.CollisionModel("objects/bigbox.stl")
object_2.set_rgba([.7, .7, .7, 1])
object_2.set_pos(np.array([.0, .0, 0.]))

object_3 = cm.CollisionModel("objects/cylinder.stl")
object_3.set_rgba([.7, .7, .7, 1])

object_4 = cm.CollisionModel("objects/strawberry.stl")
object_4.set_rgba([.7, .7, .7, 1])
object_4.set_pos(np.array([.0, .0, 0.]))
...
if finger_type == 'a':
    ...
    target_object = object_4
    target_object.attach_to(base)
elif finger_type == 'e':
    target_object = object_5
    target_object.attach_to(base)
...
#         finger_2_new.set_rotmat(finger_2_rotmat_new)
#
#         finger_1_new.set_rgba(rgba=[.7, .7, .7, 0.1])
#         finger_2_new.set_rgba(rgba=[.7, .7, .7, 0.1])
#         finger_1_new.attach_to(base)
#         finger_2_new.attach_to(base)
#         gripper_m.gen_meshmodel(rgba=[.7, .7, .7, 0.1]).attach_to(base)
