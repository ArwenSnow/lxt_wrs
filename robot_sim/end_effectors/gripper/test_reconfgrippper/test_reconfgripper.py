...
import robot_sim.end_effectors.gripper.testgripper1.testgripper1 as t1
import robot_sim.end_effectors.gripper.testgripper2.testgripper2 as t2
import robot_sim.end_effectors.gripper.PGC_300_60_W_S.PGC as PGC


class test_reconfgripper(gp.GripperInterface):
    ...
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), cdmesh_type='convex_hull', name='maingripper',
        ...
        # lft gripper
        self.lft = t1.testgripper1(pos=self.body.lft.jnts[2]['gl_posq'],
                                    rotmat=self.body.lft.jnts[2]['gl_rotmatq'],
                                    name='lft')

        # rgt gripper
        self.rgt = t2.testgripper2(pos=self.body.rgt.jnts[2]['gl_posq'],
