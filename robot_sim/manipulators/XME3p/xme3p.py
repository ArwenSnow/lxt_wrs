...
class XME3P(mi.ManipulatorInterface):
    ...
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), homeconf=np.zeros(7), name='xme3p', enable_cc=True):
        ...
        self.jlc.jnts[1]['motion_rng'] = [-2.879, 2.879]
        ...
        self.jlc.jnts[2]['motion_rng'] = [-2.007, 2.007]
        ...
        self.jlc.jnts[3]['motion_rng'] = [-2.879, 2.879]
        ...
        self.jlc.jnts[4]['motion_rng'] = [-2.007, 2.007]
        ...
        self.jlc.jnts[5]['motion_rng'] = [-2.879, 2.879]
        ...
        self.jlc.jnts[6]['motion_rng'] = [-2.007, 2.007]
        ...
        self.jlc.jnts[7]['motion_rng'] = [-6.195, 6.195]
